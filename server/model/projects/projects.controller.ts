...
import {ProjectHistory} from "../../../common/model/projects/types"
import {ProjectRepository} from "./projects.repository"

const projectsHistoryMock: ProjectHistory = {
  id: 1,
  name: "김성욱",
  projects: [
    {
...
export class ProjectController {
  ...
  "get all projects"() {
    ...
    return ProjectRepository.find({}).lean().exec()
  }
  ...
  "get projects"(
    ...
    return ProjectRepository.findOne({name}).lean().exec()
  }
  ...
  async "create projects"(
    ...
    const result = await new ProjectRepository(projectsHistoryMock).save({validateBeforeSave: true})
